...
routes.post('/physicalpersons', PhysicalPersonController.store);
...
routes.put('/physicalpersons/:id', PhysicalPersonController.update);
...
routes.get('/physicalpersons', PhysicalPersonController.index);
...
routes.get('/physicalpersons/:id', PhysicalPersonController.show);
routes.get('/personIdentitys/:id', PersonIdentityController.show);
routes.get('/personNotes/:id', NotesController.show);
...
routes.delete('/physicalpersons/:id', PhysicalPersonController.delete);
